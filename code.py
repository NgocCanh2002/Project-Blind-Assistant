...
with detection_graph.as_default():
    with tf.compat.v1.Session(graph=detection_graph) as sess:
        ...
        while (ret):
            ...
            # Mở rộng kích thước, mô hình làm cho hình ảnh có hình dạng: [1, None, None, 3]
            image_np_expanded = np.expand_dims(image_np, axis=0)
            image_tensor = detection_graph.get_tensor_by_name('image_tensor:0')
            # Mỗi Boxes đại diện cho một phần của hình ảnh nơi một đối tượng cụ thể được phát hiện.
            boxes = detection_graph.get_tensor_by_name('detection_boxes:0')
            # Mỗi điểm thể hiện mức độ tin cậy của từng đối tượng.
            # iểm được hiển thị trên hình ảnh kết quả, cùng với class label.
            ...
            # Trực quan hóa các kết quả của một phát hiện.
